  ...
  const AGORA_AUTHOR_VALUE = '__agora_revista__';
...
const hasGalleryCategorySelected =
  Boolean(
    galleryCategory?.id &&
    categoryIds.includes(
      galleryCategory.id
...
const handleSave = async ({
  ...
  if (
    hasGalleryCategorySelected
  ) {
    alert.warning(
      'Sección no disponible',
      'Galería no acepta artículos tradicionales. Crea el contenido desde el módulo Galerías.'
    );
...
const handlePublish = async () => {
  ...
  if (
    ...
    alert.warning(
      'Sección no disponible',
      'Galería se publica únicamente mediante el editor de álbumes.'
    );
  ...
  if (
    ...
    alert.warning(
      ...
      collaboratorId ===
        AGORA_AUTHOR_VALUE
        ? 'Selecciona al menos una sección para la publicación de Agorá Revista'
  ...
  const handleUnifiedUrl = async event => {
    ...
    const handleLinkSubmit = event => {
      ...
      if (editingExistingLink) {
        ...
        alert.success(
          'Enlace actualizado',
          'La dirección del enlace fue modificada correctamente'
        );
      } else {
        const {
          empty,
        ...
        if (empty) {
          alert.warning(
            'Selecciona un texto',
            'Selecciona primero el texto al que deseas agregar el enlace'
          );
        ...
        alert.success(
          'Enlace agregado',
          'El enlace fue aplicado al texto seleccionado'
        );
      }
    ...
    const handleRemoveLink = () => {
      if (!editor.isActive('link')) {
        alert.warning(
          'Sin enlace seleccionado',
          'Coloca el cursor sobre un enlace para poder eliminarlo'
        );
      ...
      alert.success(
        'Enlace eliminado',
        'El enlace fue retirado correctamente'
      );
    };
            ...
            >
              ...
              >
                ...
                >
                  ...
                  >
                    {editingExistingLink
                      ? 'Modifica la dirección vinculada al texto seleccionado.'
                      : 'Escribe la dirección que deseas aplicar al texto seleccionado.'}
                  </p>
